...
async def discover_mac():
  return template.render_template('chain.ipxe.j2', scheme=dependencies.settings['server']['scheme'], batbmp_host=dependencies.settings['server']['host'], route='/autodiscovery/{net0/mac}')
